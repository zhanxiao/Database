ALTER TABLE FN_WarehousePositionFeeBill ALTER COLUMN LineCode nvarchar(1000)
ALTER TABLE FN_WarehousePositionFeeBill ALTER COLUMN LineName nvarchar(1000)
ALTER TABLE FN_WarehousePositionFeeBill ALTER COLUMN LineCityName nvarchar(1000)
GO
